...
from catalogues.diagnosis.fsm_states import Profile
from catalogues.diagnosis.settings import ADMIN_CHAT_ID
from catalogues.diagnosis.utils import get_date_range, get_summary_message, get_time_range
from catalogues.diagnosis.vars import CITIES, DEFECT_TYPES, DEVICE_TYPES, MANUFACTURERS
